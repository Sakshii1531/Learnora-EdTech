...
// Images
import Logo from "../../assets/Logo/learnora-logo.png";
...
const Footer = () => {
  return (
    <div className="bg-[#161D29]">
      <div className="flex lg:flex-row gap-8 items-center justify-between w-8/12 max-w-maxContent text-[#6E727F] leading-6 mx-auto relative py-14">
      ...
      <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-[#6E727F] mx-auto  pb-14 text-sm">
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center">Made with ❤️ Sakshi © 2025 Learnora</div>
        </div>
      </div>
    </div>
  );
