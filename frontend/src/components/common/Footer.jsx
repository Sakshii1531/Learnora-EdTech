    ...
    <div className="bg-[#161D29]">
      ...
      <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-[#6E727F] mx-auto  pb-14 text-sm">
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
                ...
                <div
                  ...
                  className={` ${
                    BottomFooter.length - 1 === i
                      ? ""
                      : "border-r border-[#2C333F] cursor-pointer hover:text-richblack-50 transition-all duration-200"
                  } px-3 `}
                >
          ...
          <div className="text-center">Made with ❤️ Sakshi Dwivedi © 2025 learnora</div>
        </div>
      </div>
    </div>
  );
