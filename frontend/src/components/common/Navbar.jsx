...
function Navbar() {
  ...
  return (
    <div
      className={`flex h-14 relative items-center justify-center border-b border-b-[#2C333F] ${
    ...
    <div className={`w-screen md:hidden p-4 h-fit bg-richblack-800 z-50 absolute top-[55px] text-white ${showDropDown?("block"):("hidden")}  border border-white`}> 
